...
<body style="background:#F5F5F5">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/event.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
      </div>
    </div>
  </div>
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Event</h1>
      </b>
    </div>
  </div>
    ...
    <div class="row">
      <?php while ($row5 = mysqli_fetch_array($query5)) { ?>
        <div class="card mb-3" style="width:900px; margin-left:100px">
          <img src="images/<?php echo $row5["eventFoto"] ?>" class="card-img-top">
          <div class="card-body">
            <h5 class="card-title"><?php echo $row5["eventNama"] ?></h5>
            <p class="card-text"><?php echo $row5["eventKeterangan"] ?></p>
            <p class="card-text"><small class="text-muted">Tanggal Event: <?php echo $row5["eventTanggal"] ?> || Kabupaten: <?php echo $row5["kabupatenNAMA"] ?></small></p>
          </div>
        </div>
        <br>
      <?php } ?>
