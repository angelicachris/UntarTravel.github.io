...
<?php 
  ...
  $query8 = mysqli_query($connection, "SELECT provinsi.*, kabupaten.kabupatenKODE, kabupaten.kabupatenNAMA from provinsi, kabupaten WHERE provinsi.kabupatenKODE = kabupaten.kabupatenKODE");
...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/provinsi.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
    </div>
  </div>
</div>
...
<div class="jumbotron jumbotron-fluid" style="background:gray;">
  <div class="container">
    <b><h1 class="display-4" style="justify-content:center;display:flex">Provinsi</h1></b>
  </div>
</div>

<div class="container">
    <div class="row">
      <?php while($row6 = mysqli_fetch_array($query8))
      {?>
      <div class="col-sm-6 mb-4">
          <div class="card h-100" style="width: 30rem">
            <div class="card-body">
              <h5 class="card-title"><?php echo $row6["provinsiNama"]?></h5>
              <p class="card-text"><?php echo $row6["provinsiKeterangan"]?></p>
              <br>
              <p class="card-text">Kabupaten: <?php echo $row6["kabupatenNAMA"]?></p>
            </div>
          </div>
      </div>
  <br><br>
