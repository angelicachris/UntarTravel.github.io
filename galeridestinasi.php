...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/galeridestinasi.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
    </div>
  </div>
</div>
...
<div class="jumbotron jumbotron-fluid" style="background:gray;">
  <div class="container">
    <b><h1 class="display-4" style="justify-content:center;display:flex">Galeri Destinasi</h1></b>
  </div>
</div>

<div class="container">
    <div class="row">
      <?php while($row5 = mysqli_fetch_array($query8))
      {?>
      <div class="card mb-3" style="width:900px; margin-left:100px">
        <img src="images/<?php echo $row5["fotoFile"]?>" class="card-img-top" style="height:300px">
        <div class="card-body">
          <h5 class="card-title"><?php echo $row5["fotoNama"]?></h5>
          <p class="card-text"><small class="text-muted">Destinasi: <?php echo $row5["destinasiNama"]?></small></p>
        </div>
      </div>
    <br>
  <?php } ?>
        ...
        <?php if(mysqli_num_rows($berita)>0){
          ...
          {?>
                ...
                <div class="card" style="width: 40rem;">
                  ...
                  <b><p>Penulis : <?php echo $row2["penulis"]?> || Penerbit :  <?php echo $row2["penerbit"]?></p></b>
