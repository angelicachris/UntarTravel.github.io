...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/kabupaten.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
    </div>
  </div>
</div>
...
<div class="jumbotron jumbotron-fluid" style="background:gray;">
  <div class="container">
    <b><h1 class="display-4" style="justify-content:center;display:flex">Kabupaten</h1></b>
  </div>
</div>
...
<div class="container">
    <div class="row">
      <?php while($row5 = mysqli_fetch_array($query3))
      {?>
      <div class="col-sm-6">
        <div class="card mb-3" style="max-width: 540px;">
          <div class="row no-gutters">
            <div class="col-md-4">
              <img src="images/<?php echo $row5["kabupatenFOTOICON"]?>" style="width:185px; height: 300px; object-fit:cover;">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title"><?php echo $row5["kabupatenNAMA"]?></h5>
                <p class="card-text"><?php echo $row5["kabupatenALAMAT"]?></p>
                <p class="card-text"><small class="text-muted">Keterangan Foto: <?php echo $row5["kabupatenFOTOICONKET"]?></small></p>
                <p class="card-text"><small class="text-muted">Keterangan Kabupaten: <?php echo $row5["kabupatenKET"]?></small></p>
              </div>
            </div>
          </div>
        </div>
