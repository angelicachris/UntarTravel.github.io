...
$kodekat = $_GET["pindah"];
$editkat = mysqli_query($connection, "SELECT * FROM kategori WHERE kategoriID = '$kodekat'");
$rowedit = mysqli_fetch_array($editkat)
...
<body style="background:#F5F5F5">
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Kategori</h1>
      </b>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="card" style="width: 69rem">
          <div class="card-body">
            <h5 class="card-title"><?php echo $rowedit["kategoriNama"] ?></h5>
            <p class="card-text"><?php echo $rowedit["kategoriKeterangan"] ?></p>
            <br>
            <p class="card-text">Sumber: <?php echo $rowedit["kategoriReferensi"] ?></p>
          </div>
        </div>
      </div>
      <br>
