...
$query1 = mysqli_query($connection, "SELECT * FROM berita");
...
$query5 = mysqli_query($connection, "SELECT event.*, kabupaten.kabupatenKODE, kabupaten.kabupatenNAMA FROM event, kabupaten WHERE event.kabupatenKODE = kabupaten.kabupatenKODE");
$query6 = mysqli_query($connection, "SELECT * FROM kategori");
$query7 = mysqli_query($connection, "SELECT * FROM kamar");
$query8 = mysqli_query($connection, "SELECT fotodestinasi.*, destinasi.destinasiID, destinasi.destinasiNama FROM fotodestinasi, destinasi WHERE fotodestinasi.destinasiID = destinasi.destinasiID");
...
<body style="background:#F5F5F5">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item"
              href="kategori.php?pindah=<?php echo $row["kategoriID"] ?>"><?php echo $row["kategoriNama"] ?> -
              <?php echo $row["kategoriReferensi"] ?></a>
            <?php
              }
            } ?>
          </div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/news.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
      </div>
    </div>
  </div>
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Berita</h1>
      </b>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <?php while ($row5 = mysqli_fetch_array($query1)) { ?>
      <div class="card w-100">
        <div class="card-body">
          <h5 class="card-title"><?php echo $row5["beritaJudul"] ?></h5>
          <p class="card-text"><?php echo $row5["beritaInti"] ?></p>
          <b>
            <p>Penulis : <?php echo $row5["penulis"] ?> || Penerbit : <?php echo $row5["penerbit"] ?></p>
          </b>
          <p>Tanggal Terbit : <?php echo $row5["tanggalTerbit"] ?></p>
        </div>
      </div>
      <br>
      <?php } ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <iframe width="1110" height="315" src="https://www.youtube.com/embed/f59dDEk57i0" title="YouTube video player"
          frameborder="0"
