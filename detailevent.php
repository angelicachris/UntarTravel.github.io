...
$kodeev = $_GET["pindah"];
$editev = mysqli_query($connection, "SELECT * FROM event WHERE eventID = '$kodeev'");
$rowedit = mysqli_fetch_array($editev)
...
<body style="background:#F5F5F5">
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Detail Event</h1>
      </b>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="card" style="width: 69rem">
          <div class="card-body">
            <img src="images/<?php echo $rowedit["eventFoto"]?>" style="width:1060px; height: 300px; object-fit:cover;"> <br><br>
            <h5 class="card-title"><?php echo $rowedit["eventNama"] ?></h5>
            <p class="card-text"><?php echo $rowedit["eventKeterangan"] ?></p>
            <br>
            <p class="card-text">Tanggal Event: <?php echo $rowedit["eventTanggal"] ?></p>
          </div>
        </div>
      </div>
      <br>
