...
<?php 
  ...
  $query7 = mysqli_query($connection, "SELECT kuliner.*, area.areaID, area.areaNama FROM kuliner, area WHERE  kuliner.areaID = area.areaID");
...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/food.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
    </div>
  </div>
</div>
...
<div class="jumbotron jumbotron-fluid" style="background:gray;">
  <div class="container">
    <b><h1 class="display-4" style="justify-content:center;display:flex">Kuliner Nusantara</h1></b>
  </div>
</div>
      ...
      <div class="col-sm-6">
        <div class="card mb-3" style="max-width: 540px;">
          <div class="row no-gutters">
            <div class="col-md-4">
            <img src="images/<?php echo $row6["kulinerFoto"]?>" style="width:185px; height: 300px; object-fit:cover;">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title"><?php echo $row6["kulinerNama"]?></h5>
                <p class="card-text"><?php echo $row6["kulinerDeskripsi"]?></p>
                <p class="card-text"><small class="text-muted">Asal: <?php echo $row6["areaNama"]?></small></p>
              </div>
            </div>
          </div>
        </div>
...
<div class="container" style="border-top: 1px solid black; padding-top:40px">
    <div class="row">
      <div class="col-sm-12">
        <h2 style="display:flex; justify-content:center">Review Makanan Nusantara</h2><br>
        <iframe width="1110" height="355" src="https://www.youtube.com/embed/ujXykUf0PoE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
