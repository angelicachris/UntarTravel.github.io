...
$query2 = mysqli_query($connection, "SELECT hotel.*, area.areaID, area.areaNama, kabupaten.* FROM hotel, area,kabupaten WHERE hotel.areaID = area.areaID AND kabupaten.kabupatenKODE = area.kabupatenKODE");
...
$query7 = mysqli_query($connection, "SELECT kamar.*, hotel.hotelID, hotel.hotelNama FROM kamar, hotel WHERE kamar.hotelID = hotel.hotelID");
...
<body style="background:#F5F5F5">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/view2.jpg" class="d-block w-100" alt="First slide" width="640" height="630">
      </div>
    </div>
  </div>
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Pilihan Hotel Terbaik</h1>
      </b>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <?php while ($row5 = mysqli_fetch_array($query2)) { ?>
        <div class="col-sm-6 mb-4">
          <div class="card h-100" style="width: 30rem;">
            <img src="images/<?php echo $row5["hotelFoto"] ?>" class="card-img-top" style="width:477px; height: 300px">
            <div class="card-body">
              <h5 class="card-title"><?php echo $row5["hotelNama"] ?></h5>
              <br>
              <h6 class="card-subtitle mb-2 text-muted"><?php echo $row5["hotelAlamat"] ?></h6>
              <br><br>
              <p class="card-text"><?php echo $row5["hotelKeterangan"] ?></p>
              <p class="card-text"><small class="text-muted">Kabupaten: <?php echo $row5["kabupatenNAMA"] ?> || Area : <?php echo $row5["areaNama"] ?></small></p>
            </div>
          </div>
          <br>
        </div>
  ...
  <div class="jumbotron jumbotron-fluid" style="background:gray;">
    <div class="container">
      <b>
        <h1 class="display-4" style="justify-content:center;display:flex">Pilihan Kamar Terbaik</h1>
      </b>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <?php while ($row6 = mysqli_fetch_array($query7)) { ?>
        <div class="col-sm-3 mb-4">
          <div class="card border-success mb-3 h-100" style="max-width: 18rem;">
            <div class="card-body text-success">
              <h5 class="card-title"><?php echo $row6["kamarNama"] ?></h5>
              <p class="card-text"><?php echo $row6["kamarJenis"] ?> || Banyak Ranjang: <?php echo $row6["kamarbykRanjang"] ?></p>
            </div>
            <div class="card-footer bg-transparent border-success">Tersedia di: <?php echo $row6["hotelNama"] ?></div>
          </div>
        </div>
        <br>
      <?php } ?>
  ...
  <div class="container" style="border-top: 1px solid black; padding-top:40px">
    <div class="row">
      <div class="col-sm-12">
        <h2 style="display:flex; justify-content:center">Review Hotel dan Kamar</h2><br>
        <iframe width="1110" height="355" src="https://www.youtube.com/embed/u_skIvYjy-4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
